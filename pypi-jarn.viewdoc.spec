...
Source0  : https://files.pythonhosted.org/packages/48/6c/506ab1d788cb44b8c51d44182badfc319ef618cc078279d7e17a7a2e1f41/jarn.viewdoc-2.6.tar.gz
...
%prep
%setup -q -n jarn.viewdoc-2.6
cd %{_builddir}/jarn.viewdoc-2.6
pushd ..
cp -a jarn.viewdoc-2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674350008
